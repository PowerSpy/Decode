...
public class New_Intake {
    ...
    public static double transferRollerPower = 0.5;

    public static double flipperRegAngle = 0.0;
    private static double flipperTransitAngle = Math.toRadians(135.0);
    ...
    public void requestTransfer(boolean req) {
        requestTransfer = req;
    }
